# read langchain create sql agent docs
...
if db_uri==MYSQL:
    db=configure_db(db_uri,mysql_host,mysql_user,my_sql_password,mysql_db)
else:
    db=configure_db(db_uri)
    
#till now we worked on connecting
...
if user_query:
    ...
    with st.chat_message("assistnat"):
